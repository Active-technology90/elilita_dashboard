...
export default function NonSuperAdminView({
  ...
  return (
    <div className="flex w-full max-w-full flex-col items-start gap-4 lg:gap-5 xl:h-[calc(100dvh-6rem)] xl:flex-row xl:overflow-hidden">
      {/* Left: Company Identity Sidebar */}
      <div className="flex w-full flex-shrink-0 flex-col gap-3 lg:w-[300px] xl:h-full xl:w-[320px] xl:self-start xl:overflow-hidden 2xl:w-[360px]">
        {loading ? (
          <SkeletonCard />
        ) : (
      ...
      <div className="flex w-full min-w-0 flex-1 flex-col gap-3 xl:h-full xl:min-h-0 xl:overflow-hidden">
        {loading ? (
          <SkeletonWorkspace />
        ) : (
          companies.length > 0 && (
            <div className="flex flex-col gap-3 xl:h-full xl:min-h-0 xl:overflow-hidden">
              {/* Workspace Header */}
              <div className="z-20 flex-shrink-0 rounded-xl border border-gray-200 bg-white shadow-sm xl:sticky xl:top-0">
              ...
              {/* Form Container */}
              <div className="min-h-0 flex-1 rounded-xl border border-gray-200 bg-white shadow-sm xl:overflow-y-auto xl:overscroll-contain xl:scrollbar-thin xl:scrollbar-track-gray-100 xl:scrollbar-thumb-gray-300">
                <CompanyForm
                  formData={formData}
              ...
              {/* Navigation Footer */}
              <div className="z-20 flex-shrink-0 rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm xl:sticky xl:bottom-0">
